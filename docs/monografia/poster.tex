...
\posterbox[titlebox]{name=titlebox, below=top, column=1, span=2}{
  \begin{center}
...
\posterbox[footerbox]{name=footerbox, above=bottom, column=1, span=2}{
...
\posterbox[adjusted title = Introdução,
          smallmargins]
          {name=intro, below=titlebox, column=1, span=2}{
...
\posterbox[adjusted title = BERTopic,
          smallmargins]
          {name=bertopic, below=intro, column=1, span=1, rowspan=1.5}{

    \centering
    \includegraphics[width=.95\textwidth]{bertopic}

}

\posterbox[adjusted title = Mapeamento semântico,
          smallmargins]
          {name=sem_map, below=bertopic, column=1, span=1}{
...
\posterbox[adjusted title = UMAP,
          smallmargins]
          {name=umap, below=sem_map, column=1}{

    Escrever sobre redução de dimensionalidade e o UMAP
}

\posterbox[adjusted title = HDBSCAN,
          smallmargins]
          {name=hdbscan, below=intro, column=2, span=1}{
...
\posterbox[adjusted title = Bibliografia,
          smallmargins]
          {name=bibliografia, above=footerbox, column=2}{

    bibliografia
}

\posterbox[adjusted title = Resultados,
          smallmargins]
          {name=resultados, between=hdbscan and bibliografia, column=2, span=1}{
