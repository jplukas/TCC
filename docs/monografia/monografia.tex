...
\title{Análise de Textos Históricos utilizando LLMs e Modelagem de Tópicos}
\translatedtitle{Analysis of Historical Texts using LLMs and Topic Modeling}[]
...
Agradeço à minha irmã, Bia, pela riqueza de sua compania, por toda a alegria que você me proporciona e pelo seu amor. Obrigado por estar ao meu lado, e por fazer do mundo um lugar mais legal de viver. Sei que o mundo aguarda ansiosamente para ver o seu brilho, e espero poder te acompanhar nas suas jornadas.
